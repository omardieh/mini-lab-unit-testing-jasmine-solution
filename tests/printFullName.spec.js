describe("Iteration 4", () => {
  describe("Function printFullName", () => {
    ...
    it("should return a string with the first name and the last name separated by a space", () => {
      ...
      expect(printFullName({ firstName: "Jane", lastName: "Doe" })).toEqual(
        "Jane Doe"
      );
    });
    ...
    it("should return undefined if the firstName or lastName properties are not strings", () => {
      expect(printFullName({ firstName: 123, lastName: "Doe" })).toEqual(
        undefined
      );
      expect(printFullName({ firstName: "John", lastName: 123 })).toEqual(
        undefined
      );
